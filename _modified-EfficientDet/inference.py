...
def visualize_image(image,
  ...
  """
  label_map = label_util.get_label_map(label_map or 'PBBW')  #Either the PBBW or the Trash_ICRA19 map is the default instead of the coco map. Change made by Federico Zocco
