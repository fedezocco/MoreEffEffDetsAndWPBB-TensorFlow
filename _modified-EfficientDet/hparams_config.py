...
efficientdet_model_param_dict = {
    ...
    'efficientdet-d0_1-5': #Added by Federico Zocco (BiFPN with depth 1, box/class nets with depth 5)
        dict(
            name='efficientdet-d0_1-5',
            backbone_name='efficientnet-b0',
            image_size=512,
            fpn_num_filters=64,
            fpn_cell_repeats=1,
    ...
    'efficientdet-d0_5-1': #Added by Federico Zocco (BiFPN with depth 5, box/class nets with depth 1)
        dict(
            name='efficientdet-d0_5-1',
            backbone_name='efficientnet-b0',
            image_size=512,
            fpn_num_filters=64,
            fpn_cell_repeats=5,
    ...
    'efficientdet-d1_1-5': #Added by Federico Zocco (detector D1 obtained scaling-up D0(1-5) rather than D0(3-3))
        dict(
            name='efficientdet-d1_1-5',
            backbone_name='efficientnet-b1',
            image_size=640,
            fpn_num_filters=88,
            fpn_cell_repeats=2,
    ...
    'efficientdet-d2_1-5': #Added by Federico Zocco (detector D2 obtained scaling-up D0(1-5) rather than D0(3-3))
        dict(
            name='efficientdet-d2_1-5',
            backbone_name='efficientnet-b2',
            image_size=768,
            fpn_num_filters=112,
            fpn_cell_repeats=3,
    ...
    'efficientdet-d3_1-5': #Added by Federico Zocco (detector D3 obtained scaling-up D0(1-5) rather than D0(3-3))
        dict(
            name='efficientdet-d3_1-5',
            backbone_name='efficientnet-b3',
            image_size=896,
            fpn_num_filters=160,
            fpn_cell_repeats=4,
    ...
    'efficientdet-d4_1-5': #Added by Federico Zocco (detector D4 obtained scaling-up D0(1-5) rather than D0(3-3))
        dict(
            name='efficientdet-d4_1-5',
            backbone_name='efficientnet-b4',
            image_size=1024,
            fpn_num_filters=224,
            fpn_cell_repeats=5,
