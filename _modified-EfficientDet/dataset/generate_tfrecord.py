"Code taken from a GitHub repository of Lyudmil Vladimirov:" 
"https://github.com/sglvladi/TensorFlowObjectDetectionTutorial/blob/master/docs/source/scripts/generate_tfrecord.py"

# Used in the project [1] (i.e. this repository) to generate the TFrecords from the PASCAL VOC 2012 annotations of Trash-ICRA19 and WPBB datasets; the conversion was necessary since the TFrecord format is required 
# to train EfficientDets.
